    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, token_1.default)(username)];
            case 1:
                token = _b.sent();
                return [4 /*yield*/, admin_model_1.default.findOne({ email: username })];
            case 2:
                isUser = _b.sent();
...
var Register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, (0, token_1.default)(email)];
            case 2:
                token = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!(code === "sms7894")) return [3 /*break*/, 2];
                return [4 /*yield*/, admin_model_1.default.findOneAndDelete(email)];
            case 1:
                isUser = _b.sent();
                if (isUser === null) {
